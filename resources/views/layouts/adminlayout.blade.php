...
<link href="{{url('hoppler/layout/styles/layout.css')}}" rel="stylesheet" type="text/css" media="all">
...
<div class="bgded overlay" style="background-image:url('{{url('hoppler/images/demo/backgrounds/01.jpg')}}');"> 
  <!-- ################################################################################################ -->
  ...
  <!-- ################################################################################################ -->
  <!-- ################################################################################################ -->
  <div id="pageintro" class="hoc clear" style="padding-top:50px;">
    @yield('content')
  </div>
  <!-- ################################################################################################ -->
</div>
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="wrapper bgded overlay" style="background-image:url('{{url('hoppler/images/demo/backgrounds/02.png')}}');">
...
<div class="wrapper row2">
  <section class="hoc container clear"> 
    ...
    <div class="group">
      <div class="one_third first"><a class="imgover" href="#"><img src="{{url('hoppler/images/demo/320x480.png')}}" alt=""></a></div>
      <div class="two_third">
        <figure class="group">
          <div class="one_half first btmspace-30"><a class="imgover" href="#"><img src="{{url('hoppler/images/demo/320x220.png')}}" alt=""></a></div>
          <div class="one_half btmspace-30"><a class="imgover" href="#"><img src="{{url('hoppler/images/demo/320x220.png')}}" alt=""></a></div>
          <div class="one_half first"><a class="imgover" href="#"><img src="{{url('hoppler/images/demo/320x220.png')}}" alt=""></a></div>
          <div class="one_half"><a class="imgover" href="#"><img src="{{url('hoppler/images/demo/320x220.png')}}" alt=""></a></div>
        </figure>
      </div>
    </div>
    <!-- ################################################################################################ -->
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="wrapper bgded overlay" style="background-image:url('{{url('hoppler/images/demo/backgrounds/03.png')}}');">
  <div class="hoc container clear"> 
    <!-- ################################################################################################ -->
...
<div class="wrapper row2">
  <section class="hoc container clear"> 
    ...
    <div class="group team">
      <figure class="one_quarter first"><a class="imgover" href="#"><img src="{{url('hoppler/images/demo/320x320.png')}}" alt=""></a>
        <figcaption>
      ...
      <figure class="one_quarter"><a class="imgover" href="#"><img src="{{url('hoppler/images/demo/320x320.png')}}" alt=""></a>
        <figcaption>
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="wrapper bgded overlay" style="background-image:url('{{url('hoppler/images/demo/backgrounds/04.png')}}');">
  <div class="hoc container testimonials clear"> 
    <!-- ################################################################################################ -->
    <article><img src="{{url('hoppler/images/demo/100x100.png')}}" alt="">
...
<div class="wrapper row3">
  <div class="hoc container clear"> 
    ...
    <ul class="nospace group latest">
      <li class="one_third first">
        <article>
          <figure><a class="imgover" href="#"><img src="{{url('hoppler/images/demo/320x220.png')}}" alt=""></a></figure>
          <div class="txtwrap">
...
<!-- JAVASCRIPTS -->
<script src="{{url('hoppler/layout/scripts/jquery.min.js')}}"></script>
<script src="{{url('hoppler/layout/scripts/jquery.backtotop.js')}}"></script>
<script src="{{url('hoppler/layout/scripts/jquery.mobilemenu.js')}}"></script>
</body>
</html>